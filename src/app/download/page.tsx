      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-24">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-indigo-500/10 border border-indigo-500/20 rounded-full mb-8 animate-fade-in">
            ...
            <span className="text-[10px] font-black text-indigo-400 uppercase tracking-widest">Official Desktop &amp; Mobile Release</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
            <a
              href={desktopUrl}
              className="group relative px-10 py-5 bg-indigo-600 text-white font-black uppercase tracking-[0.2em] text-[12px] rounded-3xl shadow-2xl shadow-indigo-500/40 hover:bg-indigo-500 hover:scale-[1.05] active:scale-95 transition-all flex items-center gap-4"
            >
            ...
            <a
              ...
              className="group relative px-10 py-5 bg-[var(--panel-bg)] text-[var(--text-main)] border border-[var(--glass-border)] font-black uppercase tracking-[0.2em] text-[12px] rounded-3xl shadow-xl hover:border-indigo-500/50 hover:bg-indigo-500/10 hover:scale-[1.05] active:scale-95 transition-all flex items-center gap-4"
            >
