...
const PLANS = [
  {
    ...
    features: [
      ...
      "1 Profile (create once, no edit)",
      "1 Job Description (save once, no edit)",
      "Standard Engine only",
      "Small & Balanced Response Types",
      "Light Theme only",
      "Community Support",
    ],
    locked: [
      "Multiple Profile Slots & Editing",
      "Unlimited Job Descriptions",
      "Premium AI Engines",
      "Detailed & Coding Modes",
  ...
  },
  {
    ...
    features: [
      ...
      "Unlimited Profiles + Full Editing",
      "Unlimited Job Descriptions + Full Editing",
      "All Premium Engines (Pro, Coding, Titan)",
      "All Response Types (Detailed, Coding)",
  ...
  },
  {
    ...
    color: "amber",
    features: [
      "500 Credits / month per unit (5x Pro)",
      "5 Credits = 1 Resume Tailoring",
      "Turbo Engine (Elite Only)",
      "Screen Recording",
      "Universal Shortcuts",
      "Everything in Pro",
      "Dedicated Support",
