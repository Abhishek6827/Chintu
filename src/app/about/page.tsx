    ...
    <div className="min-h-screen bg-[var(--bg-app)] text-[var(--text-main)] selection:bg-teal-500/20 flex flex-col relative overflow-x-hidden">
      ...
      <main className="relative z-10 flex-1 max-w-4xl mx-auto w-full px-6 py-20">
        ...
        <motion.div
          ...
          animate="visible"
        >
          <motion.div variants={fadeUp} custom={0} className="inline-flex items-center gap-2 px-3 py-1 bg-teal-500/10 border border-teal-500/20 rounded-full mb-6">
            <Sparkles className="w-3 h-3 text-teal-400 animate-pulse" />
            <span className="text-[9px] font-black text-teal-400 uppercase tracking-widest">The Future of Interviewing</span>
          </motion.div>
          <motion.h1 variants={fadeUp} custom={1} className="text-4xl sm:text-6xl font-black tracking-tighter text-[var(--text-main)] mb-6 leading-none uppercase">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-500 via-teal-500 to-cyan-400">We help you win.</span>
          </motion.h1>
        ...
        <section className="reveal mb-32 transition-all duration-1000">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <motion.div
              ...
              className="bg-[var(--panel-bg)] p-10 rounded-[40px] border border-[var(--glass-border)] shadow-xl shadow-teal-500/5 hover:border-teal-500/50 transition-all group"
            >
              <div className="w-14 h-14 bg-teal-500/10 text-teal-500 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-6 transition-transform">
        ...
        <section className="reveal mb-32 bg-gray-900 rounded-[50px] p-12 sm:p-20 text-white overflow-hidden relative transition-all duration-1000">
          <div className="absolute top-0 right-0 w-64 h-64 bg-teal-600/20 blur-[120px] rounded-full" />
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-teal-600/20 blur-[120px] rounded-full" />
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-[var(--glass-bg)]">
                  ...
                  <th className="p-8 text-[10px] font-black uppercase tracking-widest text-teal-500 text-center">Chintu Ji</th>
              ...
              <tbody className="text-sm font-bold text-[var(--text-main)]">
                ...
                <tr className="border-t border-[var(--glass-border)]">
                  ...
                  <td className="p-8 text-center text-teal-500">&lt; 1.5s</td>
        ...
        {/* Closing */}
        <div className="reveal text-center bg-gradient-to-b from-teal-500/10 to-transparent p-12 sm:p-20 rounded-[50px] border border-teal-500/20 transition-all duration-1000">
          <h2 className="text-3xl font-black mb-6 tracking-tight text-[var(--text-main)] uppercase">Ready to excel?</h2>
          <Link href="/sign-up" className="inline-flex px-12 py-5 bg-teal-600 text-white font-black uppercase tracking-[0.2em] text-[10px] rounded-2xl shadow-2xl shadow-teal-500/40 hover:bg-teal-500 transition-all hover:scale-105">
            Join the Revolution
          </Link>
        </div>
      </main>
