    ...
    <div className="min-h-screen bg-[#f8f9fa] flex flex-col relative overflow-x-hidden overflow-y-auto" style={{ WebkitAppRegion: 'drag' } as any}>
      ...
      <div className="flex-1 flex flex-col items-center justify-start py-8 sm:py-12 pb-20 px-4 sm:px-6 no-drag relative z-10" style={{ WebkitAppRegion: 'no-drag' } as any}>
        <div className="w-full max-w-[440px] flex flex-col items-center">
          ...
          <div className="w-full bg-white rounded-[32px] border border-gray-200 shadow-2xl shadow-teal-500/5 mb-8 relative overflow-hidden group transition-all duration-500 hover:shadow-teal-500/10">
            {/* Shimmer effect */}
              ...
              <SignUp 
                ...
                appearance={{
                  elements: {
                    ...
                    socialButtonsBlockButton: "border-gray-200 hover:bg-teal-50 text-gray-700 font-bold h-12 transition-all relative overflow-hidden",
