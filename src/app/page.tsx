      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pb-8 overflow-y-auto">
        ...
        <div className="w-full max-w-sm shrink-0 flex flex-col min-h-0">
          ...
          <textarea
            ...
            className="w-full h-32 md:h-48 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl px-4 py-3 text-white text-sm placeholder:text-white/30 focus:outline-none focus:ring-2 focus:ring-white/30 resize-none shrink-0"
          />
          ...
          <button
            ...
            disabled={!jd.trim()}
            className={`
              w-full mt-4 py-3.5 rounded-2xl text-sm font-bold transition-all duration-200 shrink-0
              ${jd.trim()
