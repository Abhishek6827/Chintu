...
export default function UpdateNotification() {
  ...
  return (
    <div className="fixed bottom-6 left-6 right-6 z-[9999] animate-in slide-in-from-bottom-8 duration-500">
      <div className="bg-white/90 backdrop-blur-xl border border-teal-100 rounded-[32px] p-6 shadow-2xl shadow-teal-500/10 flex flex-col items-center text-center max-w-sm mx-auto">
        {/* Animated Icon */}
        <div className="w-16 h-16 bg-teal-50 rounded-2xl flex items-center justify-center mb-4 relative overflow-hidden group">
          <div className="absolute inset-0 bg-teal-500/10 animate-pulse" />
          <svg className="w-8 h-8 text-teal-600 relative z-10 animate-bounce" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
        ...
        <div className="grid grid-cols-2 gap-3 w-full">
          ...
          <button
            ...
            className="py-3 px-4 bg-teal-600 text-white rounded-xl shadow-lg shadow-teal-500/20 hover:bg-teal-500 hover:scale-[1.02] active:scale-95 transition-all text-[10px] font-black uppercase tracking-widest"
          >
            Restart Now
          </button>
        </div>
