  ...
  return (
    <div className="fixed inset-0 z-[200] flex flex-col items-center justify-center bg-[var(--bg-app)] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-teal-500/10 blur-[120px] rounded-full animate-pulse" />
        <div className="absolute top-1/4 left-1/4 w-[300px] h-[300px] bg-teal-500/5 blur-[80px] rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
      ...
      <div className="relative flex flex-col items-center gap-12 z-10">
        ...
        <div className="relative w-40 h-40 flex items-center justify-center">
          ...
          <div className="absolute inset-0 border-[1px] border-dashed border-teal-500/20 rounded-full animate-[spin_10s_linear_infinite]" />
          <div className="absolute inset-4 border-[1px] border-dashed border-teal-500/20 rounded-full animate-[spin_15s_linear_infinite_reverse]" />
          <div className="absolute inset-8 border-[1px] border-dashed border-cyan-500/20 rounded-full animate-[spin_20s_linear_infinite]" />

          {/* Orbital Nodes */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2 h-2 bg-teal-500 rounded-full shadow-[0_0_15px_rgba(20,184,166,1)]" />
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-2 h-2 bg-teal-500 rounded-full shadow-[0_0_15px_rgba(20,184,166,1)]" />

          {/* The Pulse Core */}
          <div className="w-20 h-20 bg-gradient-to-br from-teal-600 via-teal-600 to-cyan-500 rounded-[2.5rem] shadow-[0_0_50px_rgba(20,184,166,0.5)] flex items-center justify-center relative overflow-hidden group">
            {/* Shimmer */}
          ...
          {/* Scanline Effect */}
          <div className="absolute inset-[-40px] bg-gradient-to-b from-transparent via-teal-500/10 to-transparent h-1 opacity-50 animate-[scan_3s_linear_infinite]" />
        </div>

        <div className="flex flex-col items-center text-center px-6">
          <h2 className="text-2xl sm:text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-teal-500 via-teal-500 to-cyan-400 tracking-tighter uppercase mb-3 animate-pulse">
            {text}
          </h2>
