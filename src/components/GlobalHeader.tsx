...
export default function GlobalHeader() {
  ...
  return (
    <>
        <div className="drag-region flex items-center justify-between px-2 min-[400px]:px-3 h-12 shrink-0 relative z-[100] w-full bg-transparent backdrop-blur-md border-b border-[var(--glass-border)] shadow-sm overflow-hidden">
          <div className="flex items-center gap-1.5 min-[400px]:gap-3 no-drag">
            ...
            >
              ...
              <span className="text-sm font-black tracking-tighter uppercase text-[var(--text-main)] dark:text-white ml-2 hidden min-[400px]:inline">
