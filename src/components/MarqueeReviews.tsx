...
export function MarqueeReviews() {
  return (
    <section className="py-2 sm:py-4 relative flex w-full flex-col items-center overflow-hidden border-t border-[var(--glass-border)]">
      <div className="text-center mb-2 sm:mb-3 px-6">
